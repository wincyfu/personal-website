...
如需备份当前v1.0.7版本，执行以下命令：

```bash
# 创建v1.0.7版本备份
mkdir -p 版本备份/portfolio-x7y9z-v1.0.7
cp -R src/app/portfolio-x7y9z/* 版本备份/portfolio-x7y9z-v1.0.7/
cp src/components/UI/ProjectDetailModal.tsx 版本备份/portfolio-x7y9z-v1.0.7/
cp src/components/UI/WatermarkOverlay.tsx 版本备份/portfolio-x7y9z-v1.0.7/
cp src/components/UI/SpotlightCard.* 版本备份/portfolio-x7y9z-v1.0.7/
cp src/app/globals.css 版本备份/portfolio-x7y9z-v1.0.7/
```
...
```bash
# 回退到特定版本（以v1.0.7为例）
cp -R 版本备份/portfolio-x7y9z-v1.0.7/* src/app/portfolio-x7y9z/
cp 版本备份/portfolio-x7y9z-v1.0.7/ProjectDetailModal.tsx src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.7/WatermarkOverlay.tsx src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.7/SpotlightCard.* src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.7/globals.css src/app/
```
