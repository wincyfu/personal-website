      ...
      <div className="container mx-auto max-w-[1200px] px-6 pt-24 pb-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          <div>
            ...
            <p className={`text-lg mb-3 ${isDarkTheme ? 'text-gray-300' : 'text-gray-600'} max-w-2xl`}>
              {isEnglish 
                ? 'For complete offline viewing, welcome to download my PDF portfolio.'
                : '如需完整离线查看，欢迎下载我的 PDF 作品集。'
              }
              <a 
                href="/portfolio/WincyFu-DesignPortfolio.pdf" 
                download="WincyFu-DesignPortfolio.pdf"
                className={`inline-flex items-center px-4 py-2 ml-2 rounded-md transition-colors duration-300 text-sm font-medium ${
                  isDarkTheme 
              ...
              >
                ...
                {isEnglish ? 'Download Portfolio' : '获取 PDF 作品集'}
              </a>
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div key={project.id} className="group cursor-pointer" onClick={(e) => handleCardClick(e, project)}>
              <SpotlightCard 
                className={`all-designs-card rounded-lg h-full flex flex-col ${
                  isDarkTheme 
