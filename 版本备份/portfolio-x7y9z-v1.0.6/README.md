...
如需备份当前v1.0.6版本，执行以下命令：

```bash
# 创建v1.0.6版本备份
mkdir -p 版本备份/portfolio-x7y9z-v1.0.6
cp -R src/app/portfolio-x7y9z/* 版本备份/portfolio-x7y9z-v1.0.6/
cp src/components/UI/ProjectDetailModal.tsx 版本备份/portfolio-x7y9z-v1.0.6/
cp src/components/UI/WatermarkOverlay.tsx 版本备份/portfolio-x7y9z-v1.0.6/
cp src/components/UI/SpotlightCard.* 版本备份/portfolio-x7y9z-v1.0.6/
cp src/app/globals.css 版本备份/portfolio-x7y9z-v1.0.6/
```
...
```bash
# 回退到特定版本（以v1.0.6为例）
cp -R 版本备份/portfolio-x7y9z-v1.0.6/* src/app/portfolio-x7y9z/
cp 版本备份/portfolio-x7y9z-v1.0.6/ProjectDetailModal.tsx src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.6/WatermarkOverlay.tsx src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.6/SpotlightCard.* src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.6/globals.css src/app/
```
