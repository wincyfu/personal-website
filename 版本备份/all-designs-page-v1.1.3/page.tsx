      ...
      <div className="container mx-auto max-w-[1200px] px-6 pt-24 pb-20">
        ...
        {filteredProjects.length > 0 && (
          <div className="text-center mt-16 mb-8">
            ...
            <a 
              href="/portfolio/WincyFu-Portfolio.pdf" 
              download="WincyFu-Portfolio.pdf"
              className={`inline-flex items-center px-8 py-4 rounded-md transition-colors duration-300 text-lg font-medium ${
                isDarkTheme 
                  ? 'bg-primary hover:bg-[#1DA651] text-white' 
                  : 'bg-primary hover:bg-[#1DA651] text-white'
              }`}
            >
              ...
              {isEnglish ? 'Download Portfolio' : '下载作品集'}
            </a>
          </div>
        )}
