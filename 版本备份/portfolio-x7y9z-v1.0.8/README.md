...
**版本**: v1.0.8 (移动端设计项目时间更新版本)  
**日期**: 2025-05-15  
**状态**: 更新移动端设计第一个卡片项目时间为2019.12-2020.10
...
如需备份当前v1.0.8版本，执行以下命令：

```bash
# 创建v1.0.8版本备份
mkdir -p 版本备份/portfolio-x7y9z-v1.0.8
cp -R src/app/portfolio-x7y9z/* 版本备份/portfolio-x7y9z-v1.0.8/
cp src/components/UI/ProjectDetailModal.tsx 版本备份/portfolio-x7y9z-v1.0.8/
cp src/components/UI/WatermarkOverlay.tsx 版本备份/portfolio-x7y9z-v1.0.8/
cp src/components/UI/SpotlightCard.* 版本备份/portfolio-x7y9z-v1.0.8/
cp src/app/globals.css 版本备份/portfolio-x7y9z-v1.0.8/
```
...
```bash
# 回退到特定版本（以v1.0.8为例）
cp -R 版本备份/portfolio-x7y9z-v1.0.8/* src/app/portfolio-x7y9z/
cp 版本备份/portfolio-x7y9z-v1.0.8/ProjectDetailModal.tsx src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.8/WatermarkOverlay.tsx src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.8/SpotlightCard.* src/components/UI/
cp 版本备份/portfolio-x7y9z-v1.0.8/globals.css src/app/
```
