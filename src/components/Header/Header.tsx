        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="absolute flex flex-col items-center" style={{ 
            ...
            <div className="flex flex-col items-center mt-10">
              <div 
                className="bg-gradient-to-r from-emerald-600 to-teal-500 text-white text-opacity-90 rounded-lg cursor-pointer relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg"
